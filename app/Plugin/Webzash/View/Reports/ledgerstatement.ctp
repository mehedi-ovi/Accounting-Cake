...
echo $this->Html->link($this->Html->tag('i', '', array('class' => 'ti-eye')), array('plugin' => 'webzash', 'controller' => 'entries', 'action' => 'view',
 h($entryTypeLabel), $entry['Entry']['id']), array('rel'=>"tooltip" , 'title'=>'View' , 'class' => 'no-hover view', 'escape' => false));
...
echo $this->Form->postLink($this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-trash')) ,
 array('plugin' => 'webzash', 'controller' => 'entries', 'action' => 'delete', h($entryTypeLabel),
  $entry['Entry']['id']), array('rel'=>"tooltip" , 'title'=>'Delete' , 'class' => 'no-hover delete', 'escape' => false, 
  'confirm' => __d('webzash', 'Are you sure you want to delete the entry ?')));
